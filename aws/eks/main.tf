...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  namespace  = "kube-system"
  version    = "1.13.4" # chart version matching controller image v3.4.1 - verify current version before apply
